...
<body>
    ...
    <div class="container-fluid pdf-dash">
        <h3 class="text-center text-light pb-4">Manage PDF Books</h3>
        <div class="container">

            <div class=" mx-auto p-3 shadow d-flex justify-content-center rounded" style="background: white; width:500px;">
                <form action="upload.php" method="post" enctype="multipart/form-data">
                    <h3 class="text-center text-dark pb-2">Upload File</h3>
                    <input class="pb-3 text-dark" type="file" name="myfile">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr class="text-center">
                                ...
                                <td><a class="btn btn-primary" href="../uploads/<?php echo $row['name']; ?>" target="_blank">View</a></td>
                                ...
                                <td><a onclick="if (confirm('Delete selected item?')){return true;}else{event.stopPropagation(); event.preventDefault();};" class="btn btn-danger" href="pdf_del.php? bn=<?php echo $row['name'] ?>">Delete</a>
                                </td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="PDF_edit.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    $id = $row['id'];
                                                    $select_query = "SELECT * FROM files where id='$id'";
