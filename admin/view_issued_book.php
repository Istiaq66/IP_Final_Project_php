            ...
            <table class="table table-bordered table-hover table-secondary">
                ...
                ?>
                    <tr class="text-center">
                        ...
                        <td><a onclick="if (confirm('Delete selected item?')){return true;}else{event.stopPropagation(); event.preventDefault();};" class="btn btn-success" href="issue_delete.php? bn=<?php echo $row['s_no'] ?>">Returned</a></td>
                    </tr>
                <?php
                }
                ?>
