...
<body>
	...
	<div class="container-fluid admin-dash text-light">
		<div class="container">
			<h3 class="text-center text-light pb-4">Add Category</h3>
			<div class="row">
            <div class="col-md-4"></div>
				<div class="col-md-4">
					<form action="" method="post">
						...
						<button class="btn btn-primary" name="add_cat">Add Catergory</button>
...
if (isset($_POST['add_cat'])) {
	...
	$query = "INSERT INTO category(cat_name) VALUES ('$book_cat')";
